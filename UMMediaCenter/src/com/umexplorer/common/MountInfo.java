...
import com.umexplorer.common.SocketClient;
import java.io.*;
...
public class MountInfo {
        ...
        try {
            ...
            if (service != null) {
                ...
                for (int i = 0; i < index; i++) {
                    ...
                    else if (path[i].contains("/storage/emulated")) {
                    	type[i] = 3;
                    }
    ...
    public void isSata(int i) {
        ...
        sc1.writeMess("system find /sys/devices/platform/hiusb-ehci.0/usb1/1-1 -name \"sd*\" >> /mnt/SATA.txt");
        ...
        if (size > 0) {
            ...
            sc3.writeMess("system rm /mnt/SATA.txt");
            sc3.readNetResponseSync();
        }
        else {
            type[i] = 1;
            SocketClient sc4 = new SocketClient();
            sc4.writeMess("system rm /mnt/SATA.txt");
