package com.unionman.netsetup.interfaces;
...
import com.unionman.netsetup.view.setting.AccessPoint;
...
public class WifiAdmin {
    ...
    public static boolean sWifiRequest = true;
    ...
    public List<WifiConfiguration> getConfiguration() {
        ...
        Log.i("debug", "mWifiManager.getConfiguredNetworks()==null"
                + (list == null));
    ...
    public static boolean isWifiConnected(Context context) {
        ...
        if (networkInfo != null) {
            ...
            Log.i(TAG, "State.CONNECTED == state  : "
