...
public class NetStateDialog extends Dialog {
    ...
    public final static int CONNECT_SUCCESSED = 6;
    ...
    private static NetStateDialog mNetStateDialog = null;

    public NetStateDialog(Context context, Handler handler, int what) {
    ...
    public void refreshView(int what) {
        ...
        switch (what) {
            ...
            case CONNECT_SUCCESSED:
                mStateText.setText(R.string.net_connect_success);
                mProgressImg.setVisibility(View.GONE);
                mPositiveBtn.setVisibility(View.GONE);
                break;
            case SET_IP_FAILED:
