...
/**
 * A view for selecting a number from 0 to 9.
 */
...
//                    mDecrementButton.setVisibility(GONE);
		...
		mIncrementButton.setFocusable(false);
//		mIncrementButton.setSelected(true);
		...
		mDecrementButton.setFocusable(false);
//		mDecrementButton.setSelected(true);
		this.setFocusable(false);

        mText = (TextView) findViewById(R.id.numberpicker_input);
		...
		mText.setOnFocusChangeListener(new OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus) {
                    ...
                    mIncrementButton.setSelected(false);
                    mDecrementButton.setSelected(false);
                }
                int states[] = mIncrementButton.getDrawableState();
                ...
                if (action == KeyEvent.ACTION_DOWN) {
                    switch (keyCode) {
                        ...
                        case KeyEvent.KEYCODE_9:
                            validateCurrentView(keyCode - KeyEvent.KEYCODE_0);
                            break;
    ...
    /**
     * Sets the callback that indicates the number has been adjusted by the user.
     *
    ...
    /**
     * @see android.view.ViewGroup#focusSearch(View, int)
     */
    @Override
    public View focusSearch(View focused, int direction) {
    	...
    	if(direction == View.FOCUS_UP || direction == View.FOCUS_DOWN) {
    		...
    		int states2[] = mText.getDrawableState();
    ...
    /**
     * Sets the formatter that will be used to format the number for presentation
     * 
    ...
    /**
     * Set the range of numbers allowed for the number picker. The current
     * value will be automatically set to defvalues. Also provide a mapping
     * for values used to display to the user.
     *
     * @param start the start of the range (inclusive)
     * @param end the end of the range (inclusive)
     * @param  the values displayed to the user.
     */
