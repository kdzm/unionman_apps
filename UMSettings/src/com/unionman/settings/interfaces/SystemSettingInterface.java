package com.unionman.settings.interfaces;
...
import com.unionman.settings.util.Constant;
import com.unionman.settings.util.SystemUtils;
import com.unionman.settings.util.Util;
...
public class SystemSettingInterface {
	...
	public int getKeySoundState() {
		...
		return Util.getIndexFromArray(mode, key_sound);
	}

	public void setKeySoundState(int keySoundState) {
		boolean b = (key_sound[keySoundState][0] == 0) ? false
				: true;
