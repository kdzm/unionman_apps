...
public class ModelBDInfo implements Serializable {
    private static final long serialVersionUID = -578884547250348258L;

    private String mPath;

    private String mBDISOPath;
    ...
    public String getBDISOPath() {
        return mBDISOPath;
    }

    public void setBDISOPath(String pBDISOPath) {
        mBDISOPath = pBDISOPath;
    }
