...
import com.um.videoplayer.bd.BDInfo;
import com.um.videoplayer.bd.DVDInfo;
import com.um.videoplayer.listmanager.FMMediaFileList;
import com.um.videoplayer.util.Common;
import com.um.videoplayer.util.FilterType;
...
public class MediaFileListService extends Service {
    ...
    private Context mContext   = MediaFileListService.this;
        ...
        synchronized (lock) {
            try {
                if (this._getVideoListThread != null)
                {
                   ...
                   VideoModel currPathParent = getList().get(0);
                   ...
                   if (file.exists() && file.isDirectory())
                   {
                     ...
                     getList().clear();
                     this._getVideoListThread = new GetVideoListThread(file);
                     this._getVideoListThread.start();
                   }
                  }
            }
    ...
    public void onStart(Intent intent, int startId) {
        ...
        Intent cmd = new Intent("com.um.music.musicservicecommand");
        ...
        try {
            ...
            if (file.exists() && file.isDirectory()) {
                ...
                if (mBDInfo.isBDFile(intent.getData().toString())) {
                    i.setClassName("com.um.videoplayer", "com.um.videoplayer.activity.BDActivityNavigation");
                    ...
                    i.setClassName("com.um.videoplayer", "com.um.videoplayer.activity.DVDActivityNavigation");
                    i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    i.putExtra("path", intent.getData().toString());
                    ...
                    try {
                        ...
                        if ((mntPath != null || !mntPath.equals("")) && (mBDInfo.isBDFile(mISOLoopPath))) {
                            Log.i(TAG, "mount bd iso success:" + mISOLoopPath);
                            i.setClassName("com.um.videoplayer", "com.um.videoplayer.activity.BDActivityNavigation");
                            i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                            i.putExtra("path", mISOLoopPath);
                            i.putExtra("BDISOName", mISOName);
                            i.putExtra("BDISOPath", mISOPath);
                            MediaFileListService.this.startActivity(i);
                        }
                        else if ((mntPath != null || !mntPath.equals("")) && (mDVDInfo != null && mDVDInfo.isDVDFile(mISOLoopPath))) {
                        ...
                        Log.i(TAG, "mount iso error:" + mISOLoopPath);
                    }
                    catch (Exception e) {
                    ...
                    i.setClassName("com.um.videoplayer", "com.um.videoplayer.activity.VideoActivity");
                    i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
    ...
    public int getCurrentPathVideoSize(){
        return getList().size();
    }
            ...
            if (flag == 1) {
                ...
                if (Common.isLoadSuccess()) {
                    if (getCurrPosition() >= getList().size() - 1) {
                        ...
                        Toast.makeText(mContext,mContext.getResources().getString(R.string.toast_lastvideo), Toast.LENGTH_SHORT).show();
                        setCurrPosition(getList().size()-1);
                ...
                if (Common.isLoadSuccess()) {
                    if (getCurrPosition() <= 0) {  
                        Toast.makeText(mContext,mContext.getResources().getString(R.string.toast_firstvideo), Toast.LENGTH_SHORT).show();
                        setCurrPosition(0);
                    }
                    else {
                        setCurrPosition(getCurrPosition() - 1);
