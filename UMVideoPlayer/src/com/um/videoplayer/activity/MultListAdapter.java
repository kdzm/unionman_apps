...
public class MultListAdapter extends BaseAdapter {
	...
	public MultListAdapter(Context context, ArrayList<String> list) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView==null) {//当第一次加载ListView控件时  convertView为空
			convertView=inflater.inflate(R.layout.setting_item_dialog, null);//所以当ListView控件没有滑动时都会执行这条语句
			holder=new ViewHolder();
			holder.tv=(TextView)convertView.findViewById(R.id.advopt_dialog_item);
	...
	public static void setIsSelected(HashMap<Integer, Boolean> isSelected){
		MultListAdapter.isSelected=isSelected;
	}
