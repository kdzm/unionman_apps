...
import com.um.videoplayer.view.NetStateDialog;

/**
 * ActivityBase: business independent
 */
public class ActivityBase extends Activity {
    protected NetStateDialog mProgressDialog;
    ...
    protected void showProgressDialog() {
        //jly modify the style of ProgressDialog
        ...
        if (mProgressDialog == null) {
            mProgressDialog = NetStateDialog.createDialog(ActivityBase.this);
        }
