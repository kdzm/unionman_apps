...
public class BDInfo {
    ...
    /**
     * Check the Blueray information.
     * CN:检查蓝光信息
     *
     * @param pPath
     *        CN:蓝光目录路径
     * @return Command execution results 0- Blu ray directory not 0- not blue directory
