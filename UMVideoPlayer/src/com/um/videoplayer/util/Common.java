...
import com.um.videoplayer.activity.HisiVideoView;
import com.um.videoplayer.activity.VideoModel;
import com.um.videoplayer.dao.DBHelper;
...
public class Common {
    ...
    public void setJumpToDialog(final int title, int miniTime, final HisiVideoView videoView) {
        ...
        TimePicker timePicker = (TimePicker)linear.findViewById(R.id.timePicker);
