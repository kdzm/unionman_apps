...
import com.um.videoplayer.activity.MediaFileListService;
...
public class FMMediaFileList extends MediaFileList {
    ...
    public int getCurrentPathVideoSize() {
        ...
        checkService();
        return mediaFileListService.getCurrentPathVideoSize();
    }

	@Override
	public VideoModel getPreVideoInfo_NoCycle(List<VideoModel> list) {
		// TODO Auto-generated method stub
		checkService();
        return mediaFileListService.getVideoInfo(5);
	}
}
