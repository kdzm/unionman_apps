...
LOCAL_STATIC_JAVA_LIBRARIES := umVideoPlayer-pinyin4j-2.5.0
...
LOCAL_PACKAGE_NAME := UMVideoPlayer
...
include $(CLEAR_VARS)
LOCAL_PREBUILT_STATIC_JAVA_LIBRARIES := umVideoPlayer-pinyin4j-2.5.0:lib/pinyin4j-2.5.0.jar
LOCAL_MODULE_TAGS := optional
