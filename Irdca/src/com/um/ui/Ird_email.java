...
public class Ird_email extends AppBaseActivity
{
    ...
    public void  get_email_list() throws UnsupportedEncodingException
    {
        ...
        Log.i("Ird_email", "ret:"+ret);
        Log.i("Ird_email", "buff_len[0]:"+buff_len[0]);
        ...
        emailListView.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,long arg3)
            {
        		if(getCardStatus() != true){
        			new AlertDialog.Builder(Ird_email.this).setMessage(R.string.ca_insert_card).setPositiveButton("ok", null).show();
        			return;
        		}
                ...
                Log.e("Ird_email", "email SetOnItemClickListener"+email_index);
                ...
                it.setClass(Ird_email.this, Ird_email_read.class);
                Ird_email.this.startActivity(it);
                //Ird_email.this.finish();   //In case of refresh this activity,but is not user_friendly
            }
        ...
        emailListView.setOnKeyListener(new View.OnKeyListener()
        {
            public boolean onKey(View v, int keyCode, KeyEvent event)
            {
                ...
                if (keyCode == KeyEvent.KEYCODE_F1)
                {
                     ...
                     Log.e("Ird_email", "email open KEYCODE_F1"+email_index);
                    //SetOnItemSelectListener();  //Get focus index
                    
                    focus_index = email_cn -email_index-1;//杩涜浜嗘帓搴�
                    new AlertDialog.Builder(Ird_email.this)
                    ...
                    .setPositiveButton("ok", new DialogInterface.OnClickListener()
                    {
                        public void onClick(DialogInterface dialog, int which)
                        {
                            ...
                            if (ret == 0)
                            {
    							Toast.makeText(Ird_email.this, Ird_email.this.getResources().getString(R.string.dvt_mail_del_success), Toast.LENGTH_LONG).show();                            	
                                Ird_email.this.finish();
                				Intent it4 = new Intent(Ird_email.this,Ird_email.class);
                				startActivity(it4);
                            }
                            else if (ret == 0x80000039)
                            {
    							Toast.makeText(Ird_email.this, Ird_email.this.getResources().getString(R.string.pin_mail_not_delete), Toast.LENGTH_LONG).show();                            	                            	
                            	
                            }
                            else if (ret == 0x80000000)
                            {
    							Toast.makeText(Ird_email.this, Ird_email.this.getResources().getString(R.string.dvt_caerr_unknown), Toast.LENGTH_LONG).show();                            	                 	                            	
                            }
...
//					})
                ...
                {
                    Log.e("Ird_email", "email open KEYCODE_F2");
                    new AlertDialog.Builder(Ird_email.this)
                    ...
                    .setPositiveButton("ok", new DialogInterface.OnClickListener()
                    {
                        public void onClick(DialogInterface dialog, int which)
                        {
							...
							Toast.makeText(Ird_email.this, Ird_email.this.getResources().getString(R.string.dvt_mail_del_success), Toast.LENGTH_LONG).show();
                            Ird_email.this.finish();
            				Intent it5 = new Intent(Ird_email.this,Ird_email.class);
            				startActivity(it5);
                        }
                    }
                                      )
    ...
    public void SetOnItemSelectListener()
    {
        ...
        emailListView.setOnItemSelectedListener(new OnItemSelectedListener()
        {
            public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2, long arg3)
            {
                // TODO Auto-generated method stub
                email_index = arg2;
                Log.e("Ird_email", "email Listener"+email_index);
            }
