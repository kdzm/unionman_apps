...
public class Ird_entitle_info extends AppBaseActivity
{
...
//		 System.out.println("showEntitleInfo,jsonStr:"+jsonStr);
        byte[] productName = new byte[50];
		 ...
		 try {
				...
				Ird_email_read email_read = new Ird_email_read();
...
//					}					                
				...
				SimpleAdapter saImageItems = new SimpleAdapter(this, mylist,
						R.layout.ird_entitle_info_item, new String[] { "type", "startTime", "endTime",
