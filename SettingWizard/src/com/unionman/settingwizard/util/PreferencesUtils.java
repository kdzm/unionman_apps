...
public class PreferencesUtils {
    ...
    public static String PREFERENCE_NAME = "UmSettingWizard";
    ...
    public static boolean putRemoteString(Context remoteContex, String preferenceName, String key, String value) {
    ...
    public static String getRemoteString(Context remoteContex, String preferenceName, String key, String value) {
        SharedPreferences settings = remoteContex.getSharedPreferences(preferenceName,
                Context.MODE_WORLD_WRITEABLE | Context.MODE_MULTI_PROCESS);
        return settings.getString(key, value);
    }

    public static boolean putRemoteBoolean(Context remoteContex, String preferenceName, String key, boolean value) {
        SharedPreferences settings = remoteContex.getSharedPreferences(preferenceName,
                Context.MODE_WORLD_WRITEABLE | Context.MODE_MULTI_PROCESS);
        SharedPreferences.Editor editor = settings.edit();
    ...
    public static boolean getRemoteBoolean(Context remoteContex, String preferenceName, String key, boolean value) {
        SharedPreferences settings = remoteContex.getSharedPreferences(preferenceName,
                Context.MODE_WORLD_WRITEABLE | Context.MODE_MULTI_PROCESS);
