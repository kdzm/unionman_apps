...
import com.um.upgrade.http.HttpConstants;
import com.um.upgrade.http.HttpRequest;
import com.um.upgrade.http.HttpResponse;
 ...
 * <li>{@link #httpGet(HttpRequest, com.um.upgrade.util.HttpUtils.HttpListener)} http get asynchronous</li>
 * <li>{@link #httpGet(String, com.um.upgrade.util.HttpUtils.HttpListener)} http get asynchronous</li>
 * </ul>
 * <ul>
...
public class HttpUtils {
     ...
     * @param httpUrl
     * @return the response of the url, if null represents http error
     * @see com.um.upgrade.util.HttpUtils#httpGet(HttpRequest)
     */
     ...
     * @param httpUrl
     * @return the response of the url, if null represents http error
     * @see com.um.upgrade.util.HttpUtils#httpPost(HttpRequest)
     */
     ...
     *        {@link com.um.upgrade.util.HttpUtils#joinParas(java.util.Map)}
     * @return the content of the url, if null represents http error
     * @see com.um.upgrade.util.HttpUtils#httpPost(HttpRequest)
     */
