...
public class EQLogic implements InterfaceLogic {
    ...
    private WidgetType mEQBAND_120HZ = new WidgetType();
    private WidgetType mEQBAND_500HZ = new WidgetType();
    private WidgetType mEQBAND_1d5kHZ = new WidgetType();
    private WidgetType mEQBAND_5kHZ = new WidgetType();
    private WidgetType mEQBAND_10kHZ = new WidgetType();
    ...
    public List<WidgetType> getWidgetTypeList() {
	   ...
	   if(modeIndex!=6){
		   mEQBAND_120HZ.setEnable(false) ;
		   mEQBAND_500HZ.setEnable(false) ;
		   mEQBAND_1d5kHZ.setEnable(false) ;
		   mEQBAND_5kHZ.setEnable(false) ;
		   mEQBAND_10kHZ.setEnable(false) ;
	   }
