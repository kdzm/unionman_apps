...
//                        R.array.picture_mode_setting)[1]);
//                Stringlist.add(mContext.getResources().getStringArray(
//                        R.array.picture_mode_setting)[2]);
//                Stringlist.add(mContext.getResources().getStringArray(
//                        R.array.picture_mode_setting)[3]);
//                Stringlist.add(mContext.getResources().getStringArray(
//                        R.array.picture_mode_setting)[4]);
//                Stringlist.add(mContext.getResources().getStringArray(
//                        R.array.picture_mode_setting)[5]);
//                msg.obj = Stringlist;
