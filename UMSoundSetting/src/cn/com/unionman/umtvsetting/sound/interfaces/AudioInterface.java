...
public class AudioInterface {
    ...
    public static int EnableSWS(boolean onOff) {
        int value = getAudioManager().setAdvancedEffectParameter(
                EnumSoundAdvEftParam.E_SWS_ONOFF, onOff ? 1 : 0);
        return value;
    }
    
    public static boolean getSWS_Status() {

        boolean value = getAudioManager().getAdvancedEffectParameter(
                EnumSoundAdvEftParam.E_SWS_ONOFF) == 1 ? true : false;

        return value;
    }
    
    public static int EnableBASS(boolean onOff) {
        int value = getAudioManager().setAdvancedEffectParameter(
                EnumSoundAdvEftParam.E_SWS_BASS_ONOFF, onOff ? 1 : 0);
        return value;
    }
    
    public static boolean getBASS_Status() {

        boolean value = getAudioManager().getAdvancedEffectParameter(
                EnumSoundAdvEftParam.E_SWS_BASS_ONOFF) == 1 ? true : false;

        return value;
    }
    
    public static int EnableTREBLE(boolean onOff) {
        int value = getAudioManager().setAdvancedEffectParameter(
                EnumSoundAdvEftParam.E_SWS_TREBLE_ONOFF, onOff ? 1 : 0);
        return value;
    }
    
    public static boolean getTREBLE_Status() {

        boolean value = getAudioManager().getAdvancedEffectParameter(
                EnumSoundAdvEftParam.E_SWS_TREBLE_ONOFF) == 1 ? true : false;

        return value;
    }
    public static int EnableDIALOG(boolean onOff) {
        int value = getAudioManager().setAdvancedEffectParameter(
                EnumSoundAdvEftParam.E_SWS_DIALOG_ONOFF, onOff ? 1 : 0);
        return value;
    }
    
    public static boolean getDIALOG_Status() {

        boolean value = getAudioManager().getAdvancedEffectParameter(
                EnumSoundAdvEftParam.E_SWS_DIALOG_ONOFF) == 1 ? true : false;

        return value;
    }
    
    public static int EnableSURROUND(boolean onOff) {
        int value = getAudioManager().setAdvancedEffectParameter(
                EnumSoundAdvEftParam.E_SWS_SURROUND_ONOFF, onOff ? 1 : 0);
        return value;
    }
    
    public static boolean getSURROUND_Status() {

        boolean value = getAudioManager().getAdvancedEffectParameter(
                EnumSoundAdvEftParam.E_SWS_SURROUND_ONOFF) == 1 ? true : false;

        return value;
    }
    public static int EnableLOUDNESS(boolean onOff) {
        int value = getAudioManager().setAdvancedEffectParameter(
                EnumSoundAdvEftParam.E_SWS_LOUDNESS_ONOFF, onOff ? 1 : 0);
        return value;
    }
    
    public static boolean getLOUDNESS_Status() {

        boolean value = getAudioManager().getAdvancedEffectParameter(
                EnumSoundAdvEftParam.E_SWS_LOUDNESS_ONOFF) == 1 ? true : false;

        return value;
    }
    public static int EnableHANGMODE(boolean onOff) {
        int value = getAudioManager().setAdvancedEffectParameter(
                EnumSoundAdvEftParam.E_SWS_HANGMODE, onOff ? 1 : 0);
        return value;
    }
    
    public static boolean getHANGMODE_Status() {

        boolean value = getAudioManager().getAdvancedEffectParameter(
                EnumSoundAdvEftParam.E_SWS_HANGMODE) == 1 ? true : false;
