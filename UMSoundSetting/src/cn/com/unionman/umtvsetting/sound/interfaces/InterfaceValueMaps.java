...
//            { EnumPictureAspect.ASPECT_POINT2POINT,R.string.aspect_point2point_string }
     ...
     * Audio Track Mode
     */
    public static int[][] audio_track_mode = {
			...
			{ EnumSoundTrack.TRACK_EXCHANGE, R.string.track_mode_stereo },
			{ EnumSoundTrack.TRACK_ONLY_RIGHT, R.string.track_mode_stereo },
			{ EnumSoundTrack.TRACK_ONLY_LEFT, R.string.track_mode_stereo } };
