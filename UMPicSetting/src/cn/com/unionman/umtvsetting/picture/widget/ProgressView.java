...
public class ProgressView extends LinearLayout implements Refreshable,
    ...
    public ProgressView(CustomSettingView customSettingView, Context context,
            WidgetType widgetType, List<WidgetType> li,int offtmp) {
        super(context);
        pofftmp=offtmp;
        mContext = context;
        this.mCustomSettingView = customSettingView;
    ...
    public void initView() {
        ...
        menuTxt.setText("  " + (progress + mWidgetType.getOffset()-pofftmp));
    ...
    public void refreshUI() {
        ...
        progressViewSeekbar.setProgress(progress);
        menuTxt.setText("  " + (progress-pofftmp));
    }
                ...
                case KeyEvent.KEYCODE_DPAD_LEFT:
                    if (isOnFocus) {
                        ...
                        if (progress >= 0) {
                            ...
                            menuTxt.setText("  "
                                    + (progress + mWidgetType.getOffset()-pofftmp));
                            return true;
                        }
                    }
