package cn.com.unionman.umtvsetting.picture.interfaces;
...
public class PictureInterface {
	private int reproductionrate_value;
	private Context context;
    public static final String TAG = "PictureInterface";

    public PictureInterface(Context mContext ){
    	context = mContext;
    	SharedPreferences sharedata = context.getSharedPreferences("PoweritemVal", Activity.MODE_PRIVATE);
    	reproductionrate_value = sharedata.getInt("savingEnergy", 0);
    }
    
    public int getReproductionrate_value() {
		return reproductionrate_value;
	}

	public void setReproductionrate_value(int reproductionrate_value) {
		 Editor sharedata = context.getSharedPreferences("PoweritemVal", Activity.MODE_PRIVATE).edit();  
	      sharedata.putInt("reproductionrate_value",reproductionrate_value); 
	      sharedata.commit();
		this.reproductionrate_value = reproductionrate_value;
	}
    ...
    public static int getHue() {
        ...
        Log.i("tag", "gethue:"+getPictureManager().getHue());
   ...
   public static int getColorSystem(){
    ...
    public static int setBacklight(int backlight) {
        ...
        //add by unionman
        boolean dynamicBL = isDynamicBLEnable();
        if (dynamicBL) {
			return 1;
		}
        //by end
