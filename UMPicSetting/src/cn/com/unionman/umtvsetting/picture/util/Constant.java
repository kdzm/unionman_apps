package cn.com.unionman.umtvsetting.picture.util;
...
public class Constant {
	...
	public static final int PIC_DIALOG_RELOAD = 1; 
    public static final int PIC_DIALOG_ITEM_SHOW = 2;
	public static final int PIC_DIALOG_ITEM_DISMISS = 3;
