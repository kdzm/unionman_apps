...
import com.um.filemanager.activity.FileMenu;
import com.um.filemanager.activity.TabBarExample;
import com.um.filemanager.bd.BDInfo;
import com.um.filemanager.bd.DVDInfo;
...
public abstract class CommonActivity extends Activity {
    ...
    public final static boolean OPERATER_ENABLE = true;
    ...
    protected final static int APK_EXIT = 11;
  ...
  //  protected ProgressDialog progress;
    ...
    public void openFile(CommonActivity activity, File f) {
        ...
        if (activity.getIntent().getBooleanExtra("subFlag", false)) {
    	   ...
    	   .setMessage(getResources().getString(R.string.no_support_install_apk_for_this_machine))
...
/*            intent.setClassName("com.android.packageinstaller",
        ...
        switch (item.getItemId()) {
            ...
            case MENU_TAB:
                if (item.getTitle().equals(
                    ...
                    TabBarExample.getMain_iv().setVisibility(View.GONE);
                    TabBarExample.getMain_tv().setVisibility(View.GONE);
                    TabBarExample.getMain_tab().postInvalidate();
                    item.setTitle(R.string.show_tab);
                }
                else {
                    //              TabBarExample.getWidget().setVisibility(View.VISIBLE);
                    TabBarExample.getMain_iv().setVisibility(View.VISIBLE);
                    TabBarExample.getMain_tv().setVisibility(View.VISIBLE);
                    TabBarExample.getMain_tab().postInvalidate();
    ...
    protected void searchFileDialog() {
		...
		text.setText(R.string.input_keyword);
		...
		renameDialog.show();
    	renameDialog.getWindow().setContentView(view);
