...
public class Dvt_email_read extends AppBaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		Log.i("read email","mailid:"+index_int);
		 ...
		 {
			new AlertDialog.Builder(Dvt_email_read.this).setMessage(R.string.pin_mail_not_read).setPositiveButton("ok", null).show();
		 }
    }
