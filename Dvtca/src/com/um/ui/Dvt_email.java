...
public class Dvt_email extends AppBaseActivity
{
    ...
    public void  get_email_list() throws UnsupportedEncodingException
    {
        ...
        Log.i("Dvt_email", "ret:"+ret);
        Log.i("Dvt_email", "buff_len[0]:"+buff_len[0]);
        ...
        emailListView.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,long arg3)
            {
        		if(getCardStatus() != true){
        			new AlertDialog.Builder(Dvt_email.this).setMessage(R.string.ca_insert_card).setPositiveButton("ok", null).show();
        			return;
        		}
                ...
                Log.e("Dvt_email", "email SetOnItemClickListener"+email_index);
                ...
                dvt_cur_mail_id = email_cn -index_int-1;//进行了排序
                Log.i("Tf_email","dvt_cur_mail_id:" +dvt_cur_mail_id);
				Ca ca = new Ca(DVB.getInstance());
				int ret = ca.CaGetEmailContentByIndex(dvt_cur_mail_id, buff, buff_len);
				
				Log.i("Tf_email","CaGetEmailContentByIndex,ret:" +ret +"buff_len:" +buff_len[0]);
				if((0 != ret) || (0 == buff_len[0]))
				{	
					new AlertDialog.Builder(Dvt_email.this).setMessage(R.string.pin_mail_not_read).setPositiveButton("ok", null).show();
					return;
				}
                
                String index_str = String.valueOf(dvt_cur_mail_id);
                
                it.putExtra("email_index", index_str);   //Send data from one activity to another
                it.putExtra("email_title", email_title);
                it.setClass(Dvt_email.this, Dvt_email_read.class);
                Dvt_email.this.startActivity(it);
                //Dvt_email.this.finish();   //In case of refresh this activity,but is not user_friendly
            }
        ...
        emailListView.setOnKeyListener(new View.OnKeyListener()
        {
            public boolean onKey(View v, int keyCode, KeyEvent event)
            {
                ...
                if (keyCode == KeyEvent.KEYCODE_F1)
                {
                    ...
                    Log.e("Dvt_email", "email open KEYCODE_F1"+email_index);
                    //SetOnItemSelectListener();  //Get focus index
                    
                    focus_index = email_cn -email_index-1;//进行了排序
                    new AlertDialog.Builder(Dvt_email.this)
                    ...
                    .setPositiveButton("ok", new DialogInterface.OnClickListener()
                    {
                        public void onClick(DialogInterface dialog, int which)
                        {
                            ...
                            if (ret == 0)
                            {
    							Toast.makeText(Dvt_email.this, Dvt_email.this.getResources().getString(R.string.dvt_mail_del_success), Toast.LENGTH_LONG).show();                            	
                                Dvt_email.this.finish();
                				Intent it4 = new Intent(Dvt_email.this,Dvt_email.class);
                				startActivity(it4);
                            }
                            else if (ret == 0x80000039)
                            {
    							Toast.makeText(Dvt_email.this, Dvt_email.this.getResources().getString(R.string.pin_mail_not_delete), Toast.LENGTH_LONG).show();                            	                            	
                            	
                            }
                            else if (ret == 0x80000000)
                            {
    							Toast.makeText(Dvt_email.this, Dvt_email.this.getResources().getString(R.string.dvt_caerr_unknown), Toast.LENGTH_LONG).show();                            	                 	                            	
                            }
...
//					})
                ...
                {
                    Log.e("Dvt_email", "email open KEYCODE_F2");
                    new AlertDialog.Builder(Dvt_email.this)
                    ...
                    .setPositiveButton("ok", new DialogInterface.OnClickListener()
                    {
                        public void onClick(DialogInterface dialog, int which)
                        {
							...
							Toast.makeText(Dvt_email.this, Dvt_email.this.getResources().getString(R.string.dvt_mail_del_success), Toast.LENGTH_LONG).show();
                            Dvt_email.this.finish();
            				Intent it5 = new Intent(Dvt_email.this,Dvt_email.class);
            				startActivity(it5);
                        }
                    }
                                      )
    ...
    public void SetOnItemSelectListener()
    {
        ...
        emailListView.setOnItemSelectedListener(new OnItemSelectedListener()
        {
            public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2, long arg3)
            {
                // TODO Auto-generated method stub
                email_index = arg2;
                Log.e("Dvt_email", "email Listener"+email_index);
            }
