...
public class Wf_condition_access extends AppBaseActivity{
	final static String TAG = "Wf_condition_access";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.wf_condition_access);
		Log.v("xinhua", "恭喜打开条件接收");
        Button button1;
        button1 = (Button)findViewById(R.id.button1);
        button1.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				if(getCardStatus() != true){
					new AlertDialog.Builder(Wf_condition_access.this)
				...
				Intent it1 = new Intent(Wf_condition_access.this,Wf_smc_info.class);
				startActivity(it1);
			}
		});
...
/*
        ...
        button2.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				Intent it2 = new Intent(Wf_condition_access.this,Dvn_entitle_info.class);
				startActivity(it2);
        ...
        button3.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				Intent it3 = new Intent(Wf_condition_access.this,Dvn_email.class);
				startActivity(it3);
			        Log.v("xing.luo", "after start entitle...");
	...
	Button button4;
        ...
        button4.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				Intent it4 = new Intent(Wf_condition_access.this,Stb_version_info.class);
				startActivity(it4);
...
*/		
    ...
    private boolean getCardStatus(){
    	...
    	Log.d("Wf_condition_access", "ret:" +ret);
    	Log.d("Wf_condition_access", "cardStatus[0]:" +cardStatus[0]);
    	return cardStatus[0];
    }
...
//				Intent it12 = new Intent(Wf_condition_access.this,DvnHideMenu.class);
//				startActivity(it12);  
			}
        }
