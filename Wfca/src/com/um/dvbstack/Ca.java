...
public class Ca {	
	...
	*/
    ...
    public final native int WfcaCmdProcess(int cmdType,byte[] buf, int[] bufLen);
	...
	public final native int CaGetStbAtr(byte [] cardid,int[] len);
	public final native int CaGetAccountno(byte [] cardid,int[] len);
	public final native int CaGetMoney(byte [] cardid,int[] len);
	public final native int CaGetdvnpair(byte [] cardid,int[] len);
}
