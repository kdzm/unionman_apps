...
public class Prog
{
	...
	public void setBouquets(String[] aryBouquets)
	{
	    bouquetNames = aryBouquets;
	}
    ...
    public int getLogicNum() { return logicNum;}
	public boolean isFavProg = false;
...
//			name = new String("epg test: ��������");
			Event evt = new Event(progid, s,e,name);
			pf.add(evt);	
			count++ ;
