...
public class Tf_email_read extends AppBaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tf_email_read);
    ...
    private void showEmailContent(String jsonStr){
		 int i = 0;
		 int j = 0;
		 String email_content_str = null;
		 String send_time_str = null;
		 
		 try {  
			  	JSONObject jsonObject = new JSONObject(jsonStr);
			  	
			    send_time = jsonObject.getInt("ArrivalTime");
			    Log.i("Tf_email_read", "email read send_time:"+send_time);
			    
			    email_content_str = jsonObject.getString("content");
			    
				titleTxt = (TextView)findViewById(R.id.textTitle);
				sendTimeTxt = (TextView)findViewById(R.id.textSendtime);
				emailContentTxt = 	(TextView)findViewById(R.id.textEmailContent);	
				titleTxt.setText(email_title_str);
				emailContentTxt.setText(email_content_str);
				 
				try {
					 send_time_str = calculateSendDate(send_time);
				} catch (ParseException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
				sendTimeTxt.setText(send_time_str);
