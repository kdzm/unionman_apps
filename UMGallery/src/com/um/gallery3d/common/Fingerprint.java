...
public class Fingerprint {
    ...
    /**
     * Creates a Fingerprint based on the contents of a file. Note that this
     * will close() stream after calculating the digest.
     *
    ...
    /**
     * Encodes a 128-bit fingerprint as a string stream id. Stream id string is
     * limited to 40 characters, which could be digits, lower case ASCII and
     * underscores.
     */
