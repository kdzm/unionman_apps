...
package com.um.gallery3d.picasasource;
...
import com.um.gallery3d.data.MediaSource;
import com.um.gallery3d.data.Path;
import com.um.gallery3d.data.PathMatcher;
...
public class PicasaSource extends MediaSource {
    ...
    public static void extractExifValues(MediaObject item, ExifInterface exif) {/*
                                                                                 * do
                                                                                 * nothing
                                                                                 */
    }
