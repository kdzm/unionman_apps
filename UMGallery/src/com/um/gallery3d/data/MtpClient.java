...
public class MtpClient {
    ...
    static public boolean isCamera(UsbDevice device) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (intf.getInterfaceClass() == UsbConstants.USB_CLASS_STILL_IMAGE
                    && intf.getInterfaceSubclass() == 1 && intf.getInterfaceProtocol() == 1) {
                return true;
            }
        }
     ...
     * @param objectHandle the handle of the parent object to query, or zero for
     *            the storage root
     ...
     * @param deviceName the name of the USB device containing the object
     * @param objectHandle handle of the object to read
     * @param destPath path to destination for the file transfer. This path
     *            should be in the external storage as defined by
