...
import com.um.gallery3d.data.MediaSet.ItemConsumer;
...
class LocalSource extends MediaSource {
    ...
    public MediaObject createMediaObject(Path path) {
        ...
        switch (mMatcher.match(path)) {
            ...
            case LOCAL_ALL_ALBUM: {
                ...
                MediaSet imageSet = (MediaSet) dataManager.getMediaObject(LocalAlbumSet.PATH_IMAGE
                        .getChild(bucketId));
                MediaSet videoSet = (MediaSet) dataManager.getMediaObject(LocalAlbumSet.PATH_VIDEO
                        .getChild(bucketId));
    ...
    @Override
    public void resume() {
        mClient = mApplication.getContentResolver().acquireContentProviderClient(
