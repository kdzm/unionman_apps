...
public class MtpDevice extends MediaSet {
    ...
    public MtpDevice(Path path, GalleryApp application, int deviceId, String name,
    ...
    public MtpDevice(Path path, GalleryApp application, int deviceId, MtpContext mtpContext) {
        this(path, application, deviceId, MtpDeviceSet.getDeviceName(mtpContext, deviceId),
                mtpContext);
    }
    ...
    private void queryChildren(int storageId, int objectId, ArrayList<MtpObjectInfo> jpeg,
            ArrayList<MtpObjectInfo> dir) {
        List<MtpObjectInfo> children = mMtpContext.getMtpClient().getObjectList(mDeviceName,
                storageId, objectId);
