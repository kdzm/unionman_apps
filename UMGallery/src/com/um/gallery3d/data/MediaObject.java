...
public abstract class MediaObject {
    ...
    // BEGIN: get picture/video delete for the mount path
    public String getDeleteFilePath(Uri baseUri, GalleryApp mApplication, int id) {
        String filePath = "";
        Cursor cursor = null;

        try {
            cursor = mApplication.getContentResolver().query(baseUri, new String[] {
                ImageColumns.DATA
            }, "_id=?", new String[] {
                String.valueOf(id)
            }, null);
