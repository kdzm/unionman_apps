...
public class TimeClustering extends Clustering {
    ...
    private void setTimeRange(long timeRange, int numItems) {
        ...
        mClusterSplitTime = Utils.clamp(mClusterSplitTime, MIN_CLUSTER_SPLIT_TIME_IN_MS,
                MAX_CLUSTER_SPLIT_TIME_IN_MS);
    ...
    private static boolean isGeographicallySeparated(SmallItem itemA, SmallItem itemB) {
        ...
        double distance = GalleryUtils.fastDistanceMeters(Math.toRadians(itemA.lat),
                Math.toRadians(itemA.lng), Math.toRadians(itemB.lat), Math.toRadians(itemB.lng));
...
class Cluster {
    ...
    public String generateCaption(Context context) {
        ...
        if (minDay.substring(4).equals(maxDay.substring(4))) {
            ...
            caption = DateUtils.formatDateRange(context, minTimestamp, maxTimestamp,
            ...
            if (minDay.equals(maxDay)) {
                ...
                String dateRangeWithOptionalYear = DateUtils.formatDateTime(context, minTimestamp,
                        flags);
                ...
                if (!dateRangeWithOptionalYear.equals(dateRangeWithYear)) {
                    ...
                    caption = DateUtils.formatDateRange(context, midTimestamp, midTimestamp,
            ...
            // month and year.
            int flags = DateUtils.FORMAT_NO_MONTH_DAY | DateUtils.FORMAT_ABBREV_MONTH
