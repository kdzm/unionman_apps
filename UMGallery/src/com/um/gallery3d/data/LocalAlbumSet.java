...
public class LocalAlbumSet extends MediaSet {
    ...
    private static final String[] PROJECTION_BUCKET = {
            ImageColumns.BUCKET_ID, FileColumns.MEDIA_TYPE, ImageColumns.BUCKET_DISPLAY_NAME
    };
    ...
    protected ArrayList<MediaSet> loadSubMediaSets() {
        ...
        Cursor cursor = mApplication.getContentResolver().query(uri, PROJECTION_BUCKET,
    ...
    public static String getBucketName(ContentResolver resolver, int bucketId) {
        ...
        Cursor cursor = resolver.query(uri, PROJECTION_BUCKET, "bucket_id = ?", new String[] {
