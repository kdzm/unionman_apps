...
//import android.graphics.TiffDecoder;
...
import com.um.gallery3d.util.UpdateHelper;
...
public class LocalImage extends LocalMediaItem {
    ...
    public static class LocalImageRequest extends ImageCacheRequest {
        ...
        public Bitmap onDecodeOriginal(JobContext jc, int type) {
            ...
            if (type == MediaItem.TYPE_MICROTHUMBNAIL) {
                ...
                if (thumbData != null) {
                    Bitmap bitmap = DecodeUtils.requestDecodeIfBigEnough(jc, thumbData, options,
                            getTargetSize(type));
    ...
    static int getTargetSize(int type) {
        switch (type) {
            ...
            case TYPE_SCALE:
                return THUMBNAIL_TARGET_SCALE_SIZE;
    ...
    public int getSupportedOperations() {
        int operation = SUPPORT_DELETE | SUPPORT_SHARE | SUPPORT_CROP | SUPPORT_SETAS
                | SUPPORT_EDIT | SUPPORT_INFO;
    ...
    public void delete() {
        ...
        // delete sdcard file
        String delFilePath = getDeleteFilePath(baseUri, mApplication, id);
        boolean isDel = false;
        ...
        if (isDel) {
            ...
            Log.d(TAG, "delete file :" + delFilePath + " fail");
        }

        // end
        mApplication.getContentResolver().delete(baseUri, "_id=?", new String[] {
            String.valueOf(id)
        });
    }
    ...
    public MediaDetails getDetails() {
        ...
        // {
        // TiffDecoder.TiffSize size = TiffDecoder.getTiffFileSize(filePath);
        // details.addDetail(MediaDetails.INDEX_WIDTH,Integer.toString(size.width));
        // details.addDetail(MediaDetails.INDEX_HEIGHT,Integer.toString(size.height));
        // }
        // else if (s.equals("PNG") || s.equals("BMP"))
        // {
        ...
        // details.addDetail(MediaDetails.INDEX_WIDTH,Integer.toString(opt.outWidth));
        // details.addDetail(MediaDetails.INDEX_HEIGHT,Integer.toString(opt.outHeight));
        // }
        //
        // return details;
        return null;
