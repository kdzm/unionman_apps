...
public abstract class MediaSet extends MediaObject {
     ...
     * obtained by Future.get(). Subclasses should perform sync on a different
     * thread. The default implementation here returns a Future stub that does
     * nothing and returns SYNC_RESULT_SUCCESS by get().
     */
    ...
    private class MultiSetSyncFuture implements Future<Integer>, SyncListener {
        ...
        public void onSyncDone(MediaSet mediaSet, int resultCode) {
            ...
            synchronized (this) {
                ...
                Log.d(TAG, "onSyncDone: " + Utils.maskDebugInfo(mediaSet.getName()) + " #pending="
                        + mPendingCount);
            }
