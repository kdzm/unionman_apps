...
import com.um.gallery3d.common.Entry;
import com.um.gallery3d.common.EntrySchema;
...
public class DownloadEntry extends Entry {
    ...
    public String toString() {
        ...
        return new StringBuilder().append("hash_code: ").append(hashCode).append(", ")
                .append("content_url").append(contentUrl).append(", ").append("_size")
                .append(contentSize).append(", ").append("etag").append(eTag).append(", ")
                .append("last_access").append(lastAccessTime).append(", ").append("last_updated")
                .append(lastUpdatedTime).append(",").append("_data").append(path).toString();
    }
}
