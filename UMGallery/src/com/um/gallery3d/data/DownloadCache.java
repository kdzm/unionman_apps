...
import com.um.gallery3d.data.DownloadEntry.Columns;
...
public class DownloadCache {
    ...
    private static final String QUERY_PROJECTION[] = {
            Columns.ID, Columns.DATA
    };

    private static final String WHERE_HASH_AND_URL = String.format("%s = ? AND %s = ?",
    ...
    private Entry findEntryInDatabase(String stringUrl) {
        ...
        String whereArgs[] = {
                String.valueOf(hash), stringUrl
        };
        Cursor cursor = mDatabase.query(TABLE_NAME, QUERY_PROJECTION, WHERE_HASH_AND_URL,
    ...
    private void updateLastAccess(long id) {
        ...
        mDatabase.update(TABLE_NAME, values, ID_WHERE, new String[] {
            String.valueOf(id)
        });
    }
    ...
    private synchronized void freeSomeSpaceIfNeed(int maxDeleteFileCount) {
        ...
        Cursor cursor = mDatabase.query(TABLE_NAME, FREESPACE_PROJECTION, null, null, null, null,
                FREESPACE_ORDER_BY);
        ...
        try {
            while (maxDeleteFileCount > 0 && mTotalBytes > mCapacity && cursor.moveToNext()) {
                ...
                if (!containsKey) {
                    ...
                    mDatabase.delete(TABLE_NAME, ID_WHERE, new String[] {
                        String.valueOf(id)
                    });
                } else {
