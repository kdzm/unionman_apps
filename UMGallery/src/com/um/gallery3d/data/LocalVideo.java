...
public class LocalVideo extends LocalMediaItem {
    ...
    static final String[] PROJECTION = new String[] {
            VideoColumns._ID, VideoColumns.TITLE, VideoColumns.MIME_TYPE, VideoColumns.LATITUDE,
            VideoColumns.LONGITUDE, VideoColumns.DATE_TAKEN, VideoColumns.DATE_ADDED,
            VideoColumns.DATE_MODIFIED, VideoColumns.DATA, VideoColumns.DURATION,
            VideoColumns.BUCKET_ID, VideoColumns.SIZE
    };
    ...
    public static class LocalVideoRequest extends ImageCacheRequest {
        ...
        public Bitmap onDecodeOriginal(JobContext jc, int type) {
             ...
             * if (bitmap == null || jc.isCancelled()) return null; return
             * bitmap;
             */
            // Use the default picture instead of thumbnail images
            Bitmap pic_biBitmap = BitmapFactory.decodeResource(mApplication.getAndroidContext()
                    .getResources(), R.drawable.movie);
            return pic_biBitmap;
        }
    }
    ...
    public MediaDetails getDetails() {
        ...
        if (s > 0) {
            details.addDetail(MediaDetails.INDEX_DURATION,
                    GalleryUtils.formatDuration(mApplication.getAndroidContext(), durationInSec));
        }
