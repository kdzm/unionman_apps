...
import com.um.gallery3d.provider.GalleryProvider;
...
public class MtpImage extends MediaItem {
    ...
    MtpImage(Path path, GalleryApp application, int deviceId, MtpObjectInfo objInfo,
    ...
    public Job<BitmapRegionDecoder> requestLargeImage() {
        return new Job<BitmapRegionDecoder>() {
            public BitmapRegionDecoder run(JobContext jc) {
                ...
                return DecodeUtils.requestCreateBitmapRegionDecoder(jc, bytes, 0, bytes.length,
                        false);
            }
        };
    }
    ...
    public byte[] getImageData() {
        return mMtpContext.getMtpClient().getObject(UsbDevice.getDeviceName(mDeviceId), mObjectId,
                mObjectSize);
    }
