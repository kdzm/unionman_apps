...
import com.um.gallery3d.anim.AlphaAnimation;
import com.um.gallery3d.app.AlbumDataAdapter;
...
public class FilmStripView extends GLView implements ScrollBarView.Listener,
    ...
    // ----+----+
    // bottomMargin
    public FilmStripView(GalleryActivity activity, MediaSet mediaSet, int topMargin, int midMargin,
            int bottomMargin, int contentSize, int thumbSize, int barSize, int gripSize,
            int gripWidth) {
    ...
    public void show() {
        if (getVisibility() == GLView.VISIBLE) {
            return;
        }
    ...
    protected boolean dispatchTouchEvent(GLRootView glRootView, MotionEvent event) {
        ...
        return super.dispatchTouchEvent(glRootView, event);
    }
    ...
    protected boolean dispatchKeyEvent(GLRootView glRootView, KeyEvent event) {
        ...
        return super.dispatchKeyEvent(glRootView, event);
    }
