...
import com.um.gallery3d.ui.DetailsAddressResolver.AddressResolvingListener;
import com.um.gallery3d.ui.DetailsHelper.CloseListener;
import com.um.gallery3d.ui.DetailsHelper.DetailsSource;
import com.um.gallery3d.ui.DetailsHelper.DetailsViewContainer;
...
public class DialogDetailsView implements DetailsViewContainer {
    ...
    private void setDetails(MediaDetails details) {
        ...
        String title = String.format(
                mContext.getAndroidContext().getString(R.string.details_title), mIndex + 1,
                mSource.size());
        ListView detailsList = (ListView) LayoutInflater.from(mContext.getAndroidContext())
                .inflate(R.layout.details_list, null, false);
        detailsList.setAdapter(mAdapter);
        mDialog = new AlertDialog.Builder((Activity) mContext).setView(detailsList).setTitle(title)
