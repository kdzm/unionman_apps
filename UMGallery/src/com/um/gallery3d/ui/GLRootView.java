...
public class GLRootView extends GLSurfaceView implements GLSurfaceView.Renderer, GLRoot {
    ...
    public PICTURE_STATE state = PICTURE_STATE.NONE;
    ...
    public void setContentPane(GLView content) {
        ...
        if (mContentView != null) {
            if (mInDownState) {
                ...
                MotionEvent cancelEvent = MotionEvent.obtain(now, now, MotionEvent.ACTION_CANCEL,
                        0, 0, 0);
                mContentView.dispatchTouchEvent(this, cancelEvent);
                cancelEvent.recycle();
                mInDownState = false;
            }
    ...
    public boolean dispatchTouchEvent(MotionEvent event) {
        ...
        try {
            ...
            // event
            boolean handled = mContentView != null && mContentView.dispatchTouchEvent(this, event);
    ...
    // BEGIN: Will be distributed to each page key event
    @Override
    public boolean dispatchKeyEvent(KeyEvent event) {
        ...
        if (event.getKeyCode() == KeyEvent.KEYCODE_BACK
            ...
            return mContentView.dispatchKeyEvent(this, event);
        }

        return mContentView.dispatchKeyEvent(this, event) || super.dispatchKeyEvent(event);
    }
    ...
    public PICTURE_STATE getState() {
        return state;
    }

    public void setState(PICTURE_STATE state) {
        this.state = state;
    }
}
