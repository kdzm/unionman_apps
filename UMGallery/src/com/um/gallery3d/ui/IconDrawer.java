...
public abstract class IconDrawer extends SelectionDrawer {
    ...
    protected void drawMediaTypeOverlay(GLCanvas canvas, int mediaType, boolean isPanorama, int x,
    ...
    protected void drawPanoramaBorder(GLCanvas canvas, int x, int y, int width, int height) {
