...
public class ManageCacheDrawer extends IconDrawer {
    ...
    public ManageCacheDrawer(Context context, SelectionManager selectionManager, int cachePinSize,
            int cachePinMargin) {
        super(context);
    ...
    @Override
    public synchronized void draw(GLCanvas canvas, Texture content, int width, int height, int rotation,
            Path path, int dataSourceType, int mediaType, boolean isPanorama,
        ...
        drawCachingPin(canvas, path, dataSourceType, isCaching, chooseToCache, width, height);
    ...
    private void drawCachingPin(GLCanvas canvas, Path path, int dataSourceType, boolean isCaching,
            boolean chooseToCache, int width, int height) {
