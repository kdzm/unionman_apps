...
import com.um.gallery3d.ui.CacheStorageUsageInfo;
import com.um.gallery3d.ui.GLCanvas;
import com.um.gallery3d.ui.GLView;
import com.um.gallery3d.ui.ManageCacheDrawer;
import com.um.gallery3d.ui.MenuExecutor;
import com.um.gallery3d.ui.SelectionDrawer;
...
public class ManageCachePage extends ActivityState implements SelectionManager.SelectionListener,
        MenuExecutor.ProgressListener, EyePosition.EyePositionListener, OnClickListener {
    ...
    public void onSingleTapUp(int slotIndex) {
        ...
        mCacheStorageInfo.increaseTargetCacheSize((isFullyCached ^ isSelected) ? -sizeOfTarget
                : sizeOfTarget);
    ...
    private void initializeViews() {
        ...
        mSelectionDrawer = new ManageCacheDrawer((Context) mActivity, mSelectionManager,
                config.cachePinSize, config.cachePinMargin);
        mAlbumSetView = new AlbumSetView(mActivity, mSelectionDrawer, config.slotViewSpec,
                config.labelSpec);
        ...
        mAlbumSetView.setSimpleKeyListener(new SlotView.SimpleKeyListener() {
            ...
            @Override
            public void onKeyCenter(int slotIndex) {
                ManageCachePage.this.onSingleTapUp(slotIndex);
            }
        });
    ...
    private void initializeFooterViews() {
        ...
        Button doneButton = (Button) mFooterContent.findViewById(R.id.done);
        doneButton.setOnClickListener(this);
        // set slotview done button get used to focus
        mAlbumSetView.setDoneButton(doneButton);
        // end
    ...
    public void onClick(View view) {
        ...
        if (ids.size() == 0) {
            onBackPressed();
            mAlbumSetView.setDoneButton(null);
            return;
        }
        ...
        if (mAlbumCountToMakeAvailableOffline > 0) {
            ...
            Toast.makeText(
                    ...
                    activity.getResources().getQuantityString(
                            ...
                            mAlbumCountToMakeAvailableOffline), Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void showToastForLocalAlbum() {
        ...
        Toast.makeText(
                ...
                activity.getResources()
                        .getString(R.string.try_to_set_local_album_available_offline),
