...
import com.um.gallery3d.ui.AlbumSetView;
...
public class AlbumSetPage extends ActivityState implements SelectionManager.SelectionListener,
        GalleryActionBar.ClusterRunner, EyePosition.EyePositionListener, MediaSet.SyncListener {
    ...
    public void onSingleTapUp(int slotIndex) {
        ...
        if (mShowDetails) {
            ...
            if (mGetAlbum && targetSet.isLeafAlbum()) {
                ...
                Intent result = new Intent().putExtra(AlbumPicker.KEY_ALBUM_PATH, targetSet
                        .getPath().toString());
                ...
                if (!mGetContent
                        && (targetSet.getSupportedOperations() & MediaObject.SUPPORT_IMPORT) != 0) {
    ...
    public void onResume() {
        ...
        // When you press the back to return to reconfigure albumset total
        // number
        SlotView.sSlotCount = mAlbumSetDataAdapter.size();
        SlotView.sUnitCount = GLView.sNumRows;
        GLView.mCurrrentPhotoSlotIndex = -1;
    ...
    private void initializeViews() {
        ...
        mAlbumSetView = new AlbumSetView(mActivity, mGridDrawer, config.slotViewSpec,
                config.labelSpec);
        ...
        mAlbumSetView.setSimpleKeyListener(new SlotView.SimpleKeyListener() {
            @Override
            public void onKeyUp() {
                AlbumSetPage.this.onUp();
            }
    ...
    protected boolean onCreateActionBar(Menu menu) {
        ...
        if (mGetContent) {
            ...
            if ((typeBits & DataManager.INCLUDE_VIDEO) != 0) {
                id = (typeBits & DataManager.INCLUDE_IMAGE) == 0 ? R.string.select_video
    ...
    protected boolean onItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_manage_offline: {
                ...
                String mediaPath = mActivity.getDataManager()
