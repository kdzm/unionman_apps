...
import com.um.gallery3d.ui.SlideshowView;
...
public class SlideshowPage extends ActivityState {
    ...
    private long slideshow_delay = 3000; // 5 seconds
    ...
    public void onCreate(Bundle data, Bundle restoreState) {
        SharedPreferences share = mActivity.getAndroidContext().getSharedPreferences("Setting",
                Context.MODE_PRIVATE);
        int slidetime = share.getInt("slidetime", 0);
        switch (slidetime) {
            case 0:
    ...
    private void loadNextBitmap() {
        mModel.nextSlide(new FutureListener<Slide>() {
            public void onFutureDone(Future<Slide> future) {
                ...
                mSlideshowView.dismissProgress();
    ...
    private void showPendingBitmap() {
        ...
        setStateResult(
                Activity.RESULT_OK,
                mResultIntent.putExtra(KEY_ITEM_PATH, slide.item.getPath().toString()).putExtra(
    ...
    public void onPause() {
        ...
        // Stop playing music in the background
        // mActivity.getAndroidContext().stopService(bgMusicIntent);
    }
    ...
    private void initializeData(Bundle data) {
        ...
        // bgMusicIntent = data.getParcelable("bgMusicService");
