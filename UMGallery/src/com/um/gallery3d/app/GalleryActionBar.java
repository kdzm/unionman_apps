...
public class GalleryActionBar implements ActionBar.OnNavigationListener {
    ...
    private static final ActionItem[] sClusterItems = new ActionItem[] {
            ...
            new ActionItem(FilterUtils.CLUSTER_BY_LOCATION, true, false, R.string.locations,
                    R.string.location, R.string.group_by_location),
            new ActionItem(FilterUtils.CLUSTER_BY_TIME, true, false, R.string.times, R.string.time,
