...
import com.um.gallery3d.ui.ActionModeHandler;
import com.um.gallery3d.ui.AlbumView;
import com.um.gallery3d.ui.DetailsHelper;
import com.um.gallery3d.ui.GLCanvas;
import com.um.gallery3d.ui.GLView;
import com.um.gallery3d.ui.GridDrawer;
import com.um.gallery3d.ui.HighlightDrawer;
import com.um.gallery3d.ui.PositionProvider;
import com.um.gallery3d.ui.PositionRepository;
import com.um.gallery3d.ui.SelectionManager;
import com.um.gallery3d.ui.SlotView;
import com.um.gallery3d.ui.StaticBackground;
import com.um.gallery3d.ui.ActionModeHandler.ActionModeListener;
...
public class AlbumPage extends ActivityState implements GalleryActionBar.ClusterRunner,
    ...
    private final GLView mRootPane = new GLView() {
        ...
        protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
            ...
            GalleryUtils.setViewPointMatrix(mMatrix, (right - left) / 2, (bottom - top) / 2,
                    -mUserDistance);
            PositionRepository.getInstance(mActivity).setOffset(0, slotViewTop);
        }
    ...
    public void onSingleTapUp(int slotIndex) {
        ...
        GLView.mCurrrentPhotoSlotIndex = slotIndex;
        // end
        ...
        if (mShowDetails) {
            ...
            if (mGetContent) {
                ...
                if (GifUtils.isGifFile((Context) mActivity, manager.getContentUri(item.getPath()))) {
                    ...
                    mActivity.getStateManager().startStateForResult(PhotoPage.class, REQUEST_PHOTO,
                            data);
                }
            }
        } else {
    ...
    private void onGetContent(final MediaItem item) {
        ...
        if (mData.getString(Gallery.EXTRA_CROP) != null) {
            ...
            Intent intent = new Intent(CropImage.ACTION_CROP, uri).addFlags(
    ...
    public void doCluster(int clusterType) {
        ...
        mAlbumView.savePositions(PositionRepository.getInstance(mActivity));
        mActivity.getStateManager().startStateForResult(AlbumSetPage.class, REQUEST_DO_ANIMATION,
                data);
    }
        ...
        mAlbumView.startTransition(new PositionProvider() {
            ...
            public Position getPosition(long identity, Position target) {
                ...
                if (center != null) {
                    ...
                    mTempPosition.set(center[0], center[1], 0, random.nextInt(60) - 30, 0);
                } else {
                    mTempPosition.set(target);
                    mTempPosition.z = 128;
                }
    ...
    protected void onResume() {
        ...
        // if GLRootView lose focus else AlbumView also lose focus
        if (!GalleryUtils.isGLRootFocus) {
            AlbumPage.this.onUp();
        } else if (GalleryUtils.isGLRootFocus && GLView.mCurrrentPhotoSlotIndex != -1) {
            AlbumPage.this.onDown(GLView.mCurrrentPhotoSlotIndex);
        }

        // set NumRows
        SlotView.sUnitCount = GLView.sNumRows;
        SlotView.sSlotCount = mAlbumDataAdapter.size();
        // end
    }
    ...
    private void initializeViews() {
        ...
        mAlbumView = new AlbumView(mActivity, config.slotViewSpec, 0 /*
                                                                      * don't
                                                                      * cache
                                                                      * thumbnail
                                                                      */);
        ...
        // AbumSet remote control key processing
        mAlbumView.setSimpleKeyListener(new SlotView.SimpleKeyListener() {
            @Override
            public void onKeyUp() {
                AlbumPage.this.onUp();
            }
            ...
            public void onKeyDown(int index) {
                Log.e(TAG, "AlbumPage.onKeyDown = " + index);
                AlbumPage.this.onDown(index);
            }

            @Override
            public void onKeyCenter(int index) {
                AlbumPage.this.onSingleTapUp(index);
                Log.e(TAG, "onKeyCenter = " + index);
            }
        });
    ...
    private void initializeData(Bundle data) {
        ...
        Utils.assertTrue(mMediaSet != null, "MediaSet is null. Path = %s", mMediaSetPath);
    ...
    private void showDetails() {
        ...
        if (mDetailsHelper == null) {
            mHighlightDrawer = new HighlightDrawer(mActivity.getAndroidContext(), mSelectionManager);
    ...
    protected boolean onItemSelected(MenuItem item) {
        // if item click glRootView lose focus
        if (GalleryUtils.isGLRootFocus != false) {
            GalleryUtils.isGLRootFocus = false;
            AlbumPage.this.onUp();
        }
    ...
    private void clearLoadingBit(int loadTaskBit) {
        ...
        if (mLoadingBits == 0) {
            ...
            if (mAlbumDataAdapter.size() == 0) {
                Toast.makeText((Context) mActivity, R.string.empty_album, Toast.LENGTH_LONG).show();
