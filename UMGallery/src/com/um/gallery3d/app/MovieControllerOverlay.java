 ...
 */
public class MovieControllerOverlay extends FrameLayout implements ControllerOverlay,
        OnClickListener, AnimationListener, TimeBar.Listener {
    ...
    private void showMainView(View view) {
        ...
        playPauseReplayView.setVisibility(mainView == playPauseReplayView ? View.VISIBLE
                : View.INVISIBLE);
        show();
    }
    ...
    public void show() {
        ...
        // start In the remote control key play video
        setFocusable(true);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        playPauseReplayView.layout(cx - bw / 2, playbackButtonsCenterline - bh / 2, cx + bw / 2,
    ...
    private void updateViews() {
        ...
        playPauseReplayView.setImageResource(state == State.PAUSED ? R.drawable.ic_vidcontrol_play
