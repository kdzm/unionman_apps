...
public class AbstractGalleryActivity extends Activity implements GalleryActivity {
    ...
    protected void onStart() {
        super.onStart();
        /*
         * if (getExternalCacheDir() == null) { OnCancelListener onCancel = new
         * OnCancelListener() {
         * @Override public void onCancel(DialogInterface dialog) { finish(); }
         * }; OnClickListener onClick = new OnClickListener() {
         * @Override public void onClick(DialogInterface dialog, int which) {
         * dialog.cancel(); } }; mAlertDialog = new AlertDialog.Builder(this)
         * .setIcon(android.R.drawable.ic_dialog_alert) .setTitle("No Storage")
