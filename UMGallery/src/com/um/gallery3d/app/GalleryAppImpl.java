...
import com.um.gallery3d.data.ImageCacheService;
import com.um.gallery3d.gadget.WidgetUtils;
...
public class GalleryAppImpl extends Application implements GalleryApp {
    ...
    public static ImageFileListService mediaFileListService = null;

    public MyGalleryServiceConnection conn = null;

    public class MyGalleryServiceConnection implements ServiceConnection {

        public void onServiceConnected(ComponentName arg0, IBinder service) {
            Log.d(DEBUG, TAG, "onServiceConnected");

            if (service instanceof ImageFileListService.MyBinder) {
                mediaFileListService = ((ImageFileListService.MyBinder) service).getService();
            } else {
                mediaFileListService = null;
            }
        }

        public void onServiceDisconnected(ComponentName arg0) {
            Log.d(DEBUG, TAG, "onServiceDisconnected");
            unbindService(conn);
        }
    }
    ...
    public void onCreate() {
        super.onCreate();
        // bindService ImageFileListService
        Intent service = new Intent(ACTION);
        conn = new MyGalleryServiceConnection();
    ...
    public synchronized ImageFileListService getMediaFileListService() {
