...
import com.um.gallery3d.data.MediaDetails;
import com.um.gallery3d.data.MediaItem;
import com.um.gallery3d.data.MediaObject;
import com.um.gallery3d.data.MediaSet;
import com.um.gallery3d.data.MtpDevice;
import com.um.gallery3d.data.Path;
import com.um.gallery3d.ui.DetailsHelper;
import com.um.gallery3d.ui.FilmStripView;
import com.um.gallery3d.ui.GLCanvas;
import com.um.gallery3d.ui.GLView;
import com.um.gallery3d.ui.MenuExecutor;
import com.um.gallery3d.ui.PhotoView;
import com.um.gallery3d.ui.PositionRepository;
import com.um.gallery3d.ui.SelectionManager;
import com.um.gallery3d.ui.SynchronizedHandler;
import com.um.gallery3d.ui.UserInteractionListener;
import com.um.gallery3d.ui.DetailsHelper.CloseListener;
import com.um.gallery3d.ui.DetailsHelper.DetailsSource;
...
public class PhotoPage extends ActivityState implements PhotoView.PhotoTapListener,
        FilmStripView.Listener, UserInteractionListener {
    ...
    private final GLView mRootPane = new GLView() {
        ...
        protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
            ...
            if (mFilmStripView != null) {
                ...
                mFilmStripView
                        .layout(0, bottom - top - filmStripHeight, right - left, bottom - top);
            }
    ...
    private void initFilmStripView() {
        ...
        mFilmStripView = new FilmStripView(mActivity, mMediaSet, config.filmstripTopMargin,
                config.filmstripMidMargin, config.filmstripBottomMargin,
    ...
    public void onCreate(Bundle data, Bundle restoreState) {
        ...
        if (setPathString != null) {
            ...
            pda = new PhotoDataAdapter(mActivity, mPhotoView, mMediaSet, itemPath, mCurrentIndex);
            mModel = pda;
            ...
            pda.setDataListener(new PhotoDataAdapter.DataListener() {
                ...
                public void onPhotoChanged(int index, Path item) {
                    ...
                    mCurrentIndex = index;
                    int mediaCount = mApplication.getMediaFileListService().getSize();
                ...
                public void onPhotoAvailable(long version, boolean fullImage) {
                    mCurrentIndex = pda.getCurrentIndex();
                    if (mFilmStripView == null) {
                        initFilmStripView();
                    }
                }
        ...
        mAutoMusicSwitch.setTextOff(mActivity.getResources().getText(R.string.close_music));
        mAutoMusicSwitch.setTextOn(mActivity.getResources().getText(R.string.open_music));
        // end
        ...
        if (mShowDetails) {
            ...
            if (mCurrentPhoto != null) {
                ...
                repository.putPosition(
                        Long.valueOf(System.identityHashCode(mCurrentPhoto.getPath())), position);
            }
    ...
    public boolean actionSlideshow() {
        ...
        mActivity.getStateManager().startStateForResult(SlideshowPage.class, REQUEST_SLIDESHOW,
                data);
    ...
    public void onSingleTapUp(int x, int y) {
        ...
        if (playVideo) {
            ...
            if (GifUtils.isGifFile((Context) mActivity, manager.getContentUri(item.getPath()))) {
                GifUtils.playGif((Context) mActivity, manager.getContentUri(item.getPath()));
            } else {
    ...
    public static void playVideo(Activity activity, Uri uri, String title) {
        try {
            ...
            Toast.makeText(activity, activity.getString(R.string.video_err), Toast.LENGTH_SHORT)
                    .show();
        }
    }
    ...
    public void showToast() {
        /*View toastRoot = ((Activity) mActivity).getLayoutInflater().inflate(R.layout.customtost,
                null);
        ...
        final CustomToast mySlideToast=new CustomToast((Activity) mActivity);
        mySlideToast.setMessage(R.string.toast_ok);
		mySlideToast.showTime(3500);
		mySlideToast.getmTipsText().setTextSize(48);
		mySlideToast.getmTipsText().setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT,
				LayoutParams.MATCH_PARENT));
		mySlideToast.getmTipsText().setGravity(Gravity.CENTER);
		mySlideToast.getmTipsText().setBackgroundColor(Color.TRANSPARENT);
		mySlideToast.show();
    }
