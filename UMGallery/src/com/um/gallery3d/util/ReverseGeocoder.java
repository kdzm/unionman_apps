...
public class ReverseGeocoder {
    ...
    public ReverseGeocoder(Context context) {
        ...
        mGeoCache = CacheManager.getCache(context, GEO_CACHE_FILE, GEO_CACHE_MAX_ENTRIES,
                GEO_CACHE_MAX_BYTES, GEO_CACHE_VERSION);
    ...
    public String computeAddress(SetLatLong set) {
        ...
        if (Math.abs(set.mMaxLatLatitude - set.mMinLatLatitude) < Math.abs(set.mMaxLonLongitude
                - set.mMinLonLongitude)) {
        ...
        Location.distanceBetween(setMinLatitude, setMinLongitude, setMaxLatitude, setMaxLongitude,
                distanceFloat);
