...
public class SpinnerVisibilitySetter {
    ...
    static final WeakHashMap<Activity, SpinnerVisibilitySetter> sInstanceMap = new WeakHashMap<Activity, SpinnerVisibilitySetter>();
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case MSG_SHOW_SPINNER:
                    ...
                    if (mSpinnerVisibilityStartTime >= 0) {
                        break;
                    }
    ...
    /**
     * Gets the <code>SpinnerVisibilitySetter</code> for the given
     * <code>activity</code>. This method must be called from the main thread.
     */
