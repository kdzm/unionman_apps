...
import com.um.gallery3d.app.PackagesMonitor;
...
public class GalleryUtils {
    ...
    public static double fastDistanceMeters(double latRad1, double lngRad1, double latRad2,
            double lngRad2) {
    ...
    public static boolean isEditorAvailable(Context context, String mimeType) {
        ...
        if (prefs.getInt(updateKey, 0) != version) {
            ...
            List<ResolveInfo> infos = packageManager.queryIntentActivities(new Intent(
                    Intent.ACTION_EDIT).setType(mimeType), 0);
    ...
    public static boolean isCameraAvailable(Context context) {
        ...
        if (prefs.getInt(KEY_CAMERA_UPDATE, 0) != version) {
            PackageManager packageManager = context.getPackageManager();
            List<ResolveInfo> infos = packageManager.queryIntentActivities(new Intent(
                    MediaStore.INTENT_ACTION_STILL_IMAGE_CAMERA), 0);
    ...
    public static boolean isGLRootFocus = false;

    public static void setGlRootViewFocus(GLRootView glRootView, boolean focus) {
        if (focus) {
            if (glRootView != null) {
    ...
    public static boolean isFooterContentFocus = false;
}
