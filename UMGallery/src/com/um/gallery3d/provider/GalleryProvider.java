...
package com.um.gallery3d.provider;
...
import com.um.gallery3d.data.DownloadCache;
import com.um.gallery3d.data.MediaItem;
import com.um.gallery3d.data.MediaObject;
import com.um.gallery3d.data.MtpImage;
...
public class GalleryProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.um.gallery3d.provider";

    public static final Uri BASE_URI = Uri.parse("content://" + AUTHORITY);

    private static final String[] SUPPORTED_PICASA_COLUMNS = {
            ImageColumns.DISPLAY_NAME, ImageColumns.SIZE, ImageColumns.MIME_TYPE,
    ...
    public static Uri getUriFor(Context context, Path path) {
        ...
        return sBaseUri.buildUpon().appendEncodedPath(path.toString().substring(1)) // ignore
                                                                                    // the
                                                                                    // leading
                                                                                    // '/'
                .build();
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        try {
            ...
            if (PicasaSource.isPicasaImage(object)) {
                ...
                return queryMtpItem((MtpImage) object, projection, selection, selectionArgs,
                        sortOrder);
            } else {
                return null;
            }
    ...
    private Cursor queryMtpItem(MtpImage image, String[] projection, String selection,
    ...
    private Cursor queryPicasaItem(MediaObject image, String[] projection, String selection,
            String[] selectionArgs, String sortOrder) {
        if (projection == null) {
    ...
    public ParcelFileDescriptor openFile(Uri uri, String mode) throws FileNotFoundException {
        ...
        try {
            ...
            if (PicasaSource.isPicasaImage(object)) {
                ...
                return openPipeHelper(uri, null, null, null, new MtpPipeDataWriter(
                        (MtpImage) object));
            } else {
