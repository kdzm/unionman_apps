        ...
        gestureDetector = new GestureDetector(context,
                new GestureDetector.SimpleOnGestureListener() {
                    ...
                    public boolean onDown(MotionEvent e) {
                        // GestureDetector onTouchEvent returns true for fling
                        // events only when their
                    ...
                    public boolean onFling(MotionEvent me1, MotionEvent me2, float velocityX,
                        ...
                        if (swipeListener != null) {
                            ...
                            } else if (velocityX < -swipeThreshold && absY < absX
                                    && deltaX < -travelX) {
                                swipeListener.onSwipeLeft();
                            } else if (velocityY < -swipeThreshold && absX < absY
                                    && deltaY < -travelY) {
                                swipeListener.onSwipeUp();
                            } else if (velocityY > swipeThreshold && absX < absY / 2
                                    && deltaY > travelY) {
