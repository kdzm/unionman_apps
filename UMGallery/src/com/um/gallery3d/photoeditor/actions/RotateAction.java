...
import com.um.gallery3d.photoeditor.PhotoView;
import com.um.gallery3d.photoeditor.filters.RotateFilter;
...
public class RotateAction extends EffectAction {
    ...
    public void doBegin() {
        ...
        rotateView.setOnRotateChangeListener(new RotateView.OnRotateChangeListener() {
            ...
            // isn't fast enough.
            PhotoView photoView = (PhotoView) rotateView.getRootView()
