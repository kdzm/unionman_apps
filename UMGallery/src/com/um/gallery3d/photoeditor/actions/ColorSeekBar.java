...
/**
 * Seek-bar that has a draggable thumb to set and get the color from predefined
 * color set.
 */
class ColorSeekBar extends AbstractSeekBar {
    ...
    protected synchronized void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        // Draw two half circles in the first and last colors at seek-bar
        // left/right ends.
        ...
        canvas.restore();
        // Draw color strips that make the thumb stop at every strip's center
        // during seeking.
