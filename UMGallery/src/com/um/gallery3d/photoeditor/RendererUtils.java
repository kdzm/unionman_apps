...
public class RendererUtils {
    ...
    public static void setRenderToFit(RenderContext context, int srcWidth, int srcHeight,
        ...
        context.posVertices = createVerticesBuffer(getFitVertices(srcWidth, srcHeight, dstWidth,
                dstHeight));
    }
    ...
    public static void renderTexture(RenderContext context, int texture, int viewWidth,
            int viewHeight) {
    ...
    private static FloatBuffer createVerticesBuffer(float[] vertices) {
        ...
        FloatBuffer buffer = ByteBuffer.allocateDirect(vertices.length * FLOAT_SIZE_BYTES)
