...
package com.um.gallery3d.photoeditor.filters;
...
import com.um.gallery3d.photoeditor.Photo;
import com.um.gallery3d.photoeditor.actions.Doodle;
...
public class DoodleFilter extends Filter {
    ...
    /**
     * Signals once at least a doodle drawn within photo bounds; this filter is
     * regarded as invalid (no-op on the photo) until not all its doodling is
     * out of bounds.
     */
