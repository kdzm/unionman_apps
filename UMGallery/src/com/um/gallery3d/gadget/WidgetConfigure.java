...
import com.um.gallery3d.app.AlbumPicker;
import com.um.gallery3d.app.CropImage;
import com.um.gallery3d.app.DialogPicker;
...
public class WidgetConfigure extends Activity {
    ...
    private void setChoosenPhoto(Intent data) {
        ...
        Intent request = new Intent(CropImage.ACTION_CROP, mPickedItem)
                ...
                .putExtra(CropImage.KEY_SCALE, true).putExtra(CropImage.KEY_RETURN_DATA, true);
