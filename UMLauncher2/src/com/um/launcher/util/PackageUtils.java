 ...
 * <li>{@link com.um.launcher.util.PackageUtils#installNormal(android.content.Context, String)}</li>
 * <li>{@link com.um.launcher.util.PackageUtils#installSilent(android.content.Context, String)}</li>
 * <li>{@link com.um.launcher.util.PackageUtils#install(android.content.Context, String)}</li>
 * </ul>
 * <ul>
 * <strong>Uninstall package</strong>
 * <li>{@link com.um.launcher.util.PackageUtils#uninstallNormal(android.content.Context, String)}</li>
 * <li>{@link com.um.launcher.util.PackageUtils#uninstallSilent(android.content.Context, String)}</li>
 * <li>{@link com.um.launcher.util.PackageUtils#uninstall(android.content.Context, String)}</li>
 * </ul>
 * <ul>
 * <strong>Is system application</strong>
 * <li>{@link com.um.launcher.util.PackageUtils#isSystemApplication(android.content.Context)}</li>
 * <li>{@link com.um.launcher.util.PackageUtils#isSystemApplication(android.content.Context, String)}</li>
 * <li>{@link com.um.launcher.util.PackageUtils#isSystemApplication(android.content.pm.PackageManager, String)}</li>
 * </ul>
 * <ul>
 * <strong>Others</strong>
 * <li>{@link com.um.launcher.util.PackageUtils#getInstallLocation()} get system install location</li>
 * <li>{@link com.um.launcher.util.PackageUtils#isTopActivity(android.content.Context, String)} whether the app whost package's name is packageName is on the
 * top of the stack</li>
 * <li>{@link com.um.launcher.util.PackageUtils#startInstalledAppDetails(android.content.Context, String)} start InstalledAppDetails Activity</li>
 * </ul>
 * 
...
public class PackageUtils {
     ...
     */
    public static void stopPackage(String packageName , boolean stop) {
        ...
        try {
            ...
            Log.e("Utils.stopPackage: ", "Is Package Manager running?");
        }
    }
     ...
     * @return
     */
    public static PackageInfo getPackageInfoByFile(Context context, String apkFilePath) {
     ...
     * @return 返回没有被安装的包名
     */
    public static List<String> findUninstallPackages(Context context, List<String> packageNames) {
        List<String> unInstallPackages = new ArrayList<String>();
    ...
    /**
     * 根据提供的软件包路径列表查找是否都有安装，
     * @param context
     * @param apkPaths apk列表
     * @return 返回没有被安装的文件路径列表
     */
    public static List<String> findUninstallByFiles(Context context, List<String> apkPaths) {
        List<String> unInstallApk = new ArrayList<String>();
        String packageName;
        for (String apkPath : apkPaths) {
            packageName = getPackageInfoByFile(context, apkPath).packageName;
            if (!isPackageInstalled(context, packageName)) {
                unInstallApk.add(apkPath);
            }
        }
        return unInstallApk;
    }
     ...
     * @param context
     * @param filePath file path of package
     * @return {@link com.um.launcher.util.PackageUtils#INSTALL_SUCCEEDED} means install success, other means failed. details see
     * {@link com.um.launcher.util.PackageUtils}.INSTALL_FAILED_*. same to {@link android.content.pm.PackageManager}.INSTALL_*
    ...
    public static Boolean isTopActivity(Context context, String packageName, String activityName) {
        ...
        try {
            ...
            String topActivityName = tasksInfo.get(0).topActivity.getShortClassName();
            LogUtils.d("topPackageName: " + topPackageName + ", topActivityName: " + topActivityName);
            if (StringUtils.isBlank(activityName)) {
                return packageName.equals(topPackageName);
            } else {
                return packageName.equals(topPackageName) && topActivityName.equals(activityName);
            }
        } catch (Exception e) {
            e.printStackTrace();
            return false;
