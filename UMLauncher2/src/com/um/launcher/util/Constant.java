...
public class Constant {
     ...
     */
    public static final String SET_LACOLE = "setlocale";
    public static final String RESET_LACOLE = "resetlocale";
    ...
    public static final String Default_Remote_Controller_Name = "UMBTRM1.0";
    public static final String Default_Start_Apk_Package_Name = "com.unionman.umlauncher";
    public static final String Default_Start_Apk_MainClass_Name = "com.unionman.umlauncher.MainActivity";
}
