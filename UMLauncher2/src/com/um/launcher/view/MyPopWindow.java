...
public class MyPopWindow extends AlertDialog implements
    ...
    public void init() {
        ...
        linearLayout.setBackgroundResource(R.drawable.setting_dialog_bg);
        ...
        String appName = mResolveInfo.loadLabel(mPackManager).toString();
        txtView.setText(appName);
        ...
        for (int i = 0; i < mResource.length; i++) {
            ...
            but.setTag(i);
            but.setBackgroundResource(R.drawable.linearlayout_background);
        ...
        setContentView(linearLayout, new LayoutParams(width * 913 / 1920,
                height * 572 / 1080));
