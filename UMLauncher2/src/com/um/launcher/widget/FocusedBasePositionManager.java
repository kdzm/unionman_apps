...
public abstract class FocusedBasePositionManager {
    ...
    public void drawFrame(Canvas paramCanvas) {
        LogUtils.d("drawFrame: mCurrentFrame = " + this.mCurrentFrame + ", needDraw = " + this.mNeedDraw + ", mode = " + this.mode + ", mScaleXValue = " + this.mScaleXValue + ", mScaleYValue = " + this.mScaleYValue + ", mFocusFrameRate = " + this.mFocusFrameRate + ", mScaleFrameRate" + this.mScaleFrameRate);
    ...
    public void setSelectedView(View paramView) {
        LogUtils.d("setSelectedView v = " + paramView);
    ...
    private void drawSyncFrame(Canvas paramCanvas) {
        ...
        if (getSelectedView() != null) {
            ...
            LogUtils.w("drawSyncFrame select view is null");
    }

    private void drawAsyncFrame(Canvas paramCanvas) {
        LogUtils.i("drawAsyncFrame");
        if (getSelectedView() != null) {
            ...
            LogUtils.w("drawAsyncFrame select view is null");
        }
    }

    private void drawStaticFrame(Canvas paramCanvas) {
        LogUtils.i("drawStaticFrame");
        if (getSelectedView() != null) {
            if ((this.mCurrentFrame < this.mFrameRate) && (this.mNeedDraw)) {
                if (this.mIsFirstFrame)
    ...
    private void drawFirstFrame(Canvas paramCanvas, boolean paramBoolean1, boolean paramBoolean2) {
        ...
        LogUtils.d("drawFirstFrame: mFocusRect = " + this.mFocusRect + ", this = " + this);
    ...
    private void drawOtherFrame(Canvas paramCanvas, boolean paramBoolean1, boolean paramBoolean2) {
        LogUtils.i("drawOtherFrame, this = " + this);
        this.mIsLastFrame = false;
        drawScale(paramBoolean1);
        if (hasFocus())
            drawFocus(paramCanvas, paramBoolean2);
    ...
    private void drawLastFrame(Canvas paramCanvas, boolean paramBoolean1, boolean paramBoolean2) {
        LogUtils.i("drawLastFrame, this = " + this);
        Rect localRect = getDstRectBeforeScale(true);
        if (null == localRect)
            return;
    ...
    private void scaleSelectedView() {
        ...
        if (localView != null) {
            ...
            LogUtils.d("scaleSelectedView: dstScaleX = " + f3 + ", dstScaleY = " + f4 + ", mScaleXValue = " + this.mScaleXValue + ", mScaleYValue = " + this.mScaleYValue + ", Selected View = " + localView + ", this = " + this);
    ...
    private void scaleLastSelectedView() {
        if (this.mLastSelectedView != null) {
            ...
            float f3 = 1.0F + f1 * j / i;
            float f4 = 1.0F + f2 * j / i;
            LogUtils.d("scaleLastSelectedView: dstScaleX = " + f3 + ", dstScaleY = " + f4 + ", mScaleXValue = " + this.mScaleXValue + ", mScaleYValue = " + this.mScaleYValue + ", mLastSelectedView = " + this.mLastSelectedView + ", this = " + this + ", mCurrentFrame = " + this.mCurrentFrame);
    ...
    private void drawScale(boolean paramBoolean) {
        LogUtils.d("drawScale: mCurrentFrame = " + this.mCurrentFrame + ", mScaleXValue = " + this.mScaleXValue + ", mScaleYValue = " + this.mScaleYValue + ", this = " + this + ", mScaleCurrentView = " + this.mScaleCurrentView + ", mScaleLastView = " + this.mScaleLastView);
    ...
    private void drawFocus(Canvas paramCanvas, boolean paramBoolean) {
        LogUtils.d("drawFocus: mCurrentFrame = " + this.mCurrentFrame + ", mScaleXValue = " + this.mScaleXValue + ", mScaleYValue = " + this.mScaleYValue + ", this = " + this);
    ...
    private void drawStaticFocus(Canvas paramCanvas) {
        ...
        float f3 = 1.0F + f1 * j / i;
        float f4 = 1.0F + f2 * j / i;
        LogUtils.i("drawStaticFocus: mCurrentFrame = " + this.mCurrentFrame + ", dstScaleX = " + f3 + ", dstScaleY = " + f4 + ", mScaleXValue = " + this.mScaleXValue + ", mScaleYValue = " + this.mScaleYValue + ", this = " + this);
        ...
        if ((getSelectedView() != null) && (paramCanvas != null) && ((this.mState == STATE_IDLE) || (isLastFrame())))
    ...
    private void drawDynamicFocus(Canvas paramCanvas) {
        ...
        LogUtils.i("drawDynamicFocus: mCurrentFrame = " + this.mCurrentFrame + ", dstRect.left = " + localRect.left + ", dstRect.right = " + localRect.right + ", dstRect.top = " + localRect.top + ", dstRect.bottom = " + localRect.bottom + ", this = " + this);
        this.mCurrentRect = localRect;
        this.mMySelectedDrawable.setBounds(localRect);
        this.mMySelectedDrawable.draw(paramCanvas);
        this.mMySelectedDrawable.setVisible(true, true);
    ...
    public void computeScaleXY() {
        if ((SCALED_FIXED_X == this.mScaledMode) || (SCALED_FIXED_Y == this.mScaledMode)) {
            ...
            LogUtils.d("computeScaleXY mScaleXValue = " + this.mScaleXValue + ", mScaleYValue = " + this.mScaleYValue + ", mFixedScaledX = " + this.mFixedScaledX + ", mFixedScaledY = " + this.mFixedScaledY + ", height = " + j + ", width = " + i);
        }
    }
