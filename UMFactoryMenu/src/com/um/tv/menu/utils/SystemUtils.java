...
public class SystemUtils {
	...
	private final static SocketClient mConfigServerSocket = new SocketClient();
	
	public static int rebootForInitSystem(Context context) {
		int result = -1;
	...
	public static int removeDirAndFile(String path) {
	...
	public static int shellExecute(String cmd) {
		SocketClient socketClietn = new SocketClient(); 
		socketClietn.writeMsg("system " + cmd);
		return socketClietn.readNetResponseSync();
	}
