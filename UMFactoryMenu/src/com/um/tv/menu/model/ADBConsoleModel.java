...
public class ADBConsoleModel extends Model {
	private static final String TAG = "ADBConsoleModel";
	
	public ADBConsoleModel(Context context, FactoryWindow window,
			CusFactory factory) {
		super(context, window, factory);
		// TODO Auto-generated constructor stub
		mName = Utils.DisplayNameADBConsole;
	}
