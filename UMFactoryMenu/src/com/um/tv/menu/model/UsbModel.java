...
public class UsbModel extends Model {
    public String mDisplayName = "USB";
    public String[] mItemNames = Utils.ItemsUSB;

    public UsbModel(Context context, FactoryWindow window, CusFactory factory) {
    ...
    private void initChildren() {
    	ChoiceModel spreadEnable = new ChoiceModel(mContext, mWindow, mFactory, ChoiceModel.TypeUSBSpreadEnable);
    	...
    	RangeModel drvCur = new RangeModel(mContext, mWindow, mFactory, RangeModel.TypeDdrSpreadFreq);
    	drvCur.mName = mItemNames[3];
    	addChild(drvCur);
    }
