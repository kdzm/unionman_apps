...
public class CIModel extends Model {
    public String mDisplayName = "CI";
    public String[] mItemNames = Utils.ItemsCI;

    public CIModel(Context context, FactoryWindow window, CusFactory factory) {
    ...
    private void initChildren() {
    	ChoiceModel enable = new ChoiceModel(mContext, mWindow, mFactory, ChoiceModel.TypeCIEnable);
