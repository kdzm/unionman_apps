...
package com.um.launcher.coverflow;
...
public class CoverFlowMovie extends LinearLayout {

    private static final String TAG = "CoverFlowMovie";
    List<AnimableControl> ControlList;
    CoverFlowLayout mMyLinearLayout;
    public static ImageView sImageView1 = null;
    public static ImageView sImageView2 = null;
    public static ImageView sImageView3 = null;
    public static ImageView sImageView4 = null;
    public static ImageView sImageView5 = null;
    private View mView;
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (Constant.LOG_TAG) {
            for (int i = 0; i < positions.length; i++) {
                Log.d(TAG, "positions:" + i + ":" + positions[i]);
            }
        }
        ...
        if (!mFlag) {
            ...
            ControlList.add(mAnimableControl1);
            ControlList.add(mAnimableControl2);
            ControlList.add(mAnimableControl3);
            ControlList.add(mAnimableControl4);
            ControlList.add(mAnimableControl5);
            mMyLinearLayout.setControlList(ControlList);
    ...
    public CoverFlowMovie(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        if (Constant.LOG_TAG) {
            Log.d(TAG, "cover flow images:" + images + ": delayTime:"
                    + mDelayTime);
        }
        initView(images);
        typedArray.recycle();
    ...
    public CoverFlowMovie(Context context) {
        super(context);
        this.mContext = context;
        initView(null);
    }
    ...
    private void initView(TypedArray images) {
        ...
        mView = mLayoutInflater.inflate(R.layout.coverflow_movie, this);
        mMyLinearLayout = (CoverFlowLayout) mView.findViewById(R.id.container);

        sImageView1 = (ImageView) mView.findViewById(R.id.movie_first);
        sImageView2 = (ImageView) mView.findViewById(R.id.movie_second);
        sImageView3 = (ImageView) mView.findViewById(R.id.movie_third);
        sImageView4 = (ImageView) mView.findViewById(R.id.movie_four);
        sImageView5 = (ImageView) mView.findViewById(R.id.movie_five);

        if (images == null && images.length() < 5) {
            throw new RuntimeException(
                    "Images arrays length doesn't match ,images number should be five");
        }
        ...
        sImageView1.setX(89.0f);
        sImageView2.setX(232.0f);
        sImageView3.setX(402.0f);
        sImageView4.setX(572.0f);
        sImageView5.setX(715.0f);

        ControlList = new ArrayList<AnimableControl>();
    }
