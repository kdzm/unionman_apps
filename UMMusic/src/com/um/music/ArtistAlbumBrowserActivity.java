...
import com.um.music.QueryBrowserActivity.QueryListAdapter.QueryHandler;
...
public class ArtistAlbumBrowserActivity extends ExpandableListActivity
    ...
    public boolean onChildClick(ExpandableListView parent, View v,
        ...
        // Conditions for the album and artists query
        if (album == null || album.equals(MediaStore.UNKNOWN_STRING) || true) {
        ...
        public void bindChildView(View view, Context context, Cursor cursor,
            ...
            if (numsongs == 1) {
                ...
                if (numsongs == numartistsongs) {
                    ...
                    args[0] = numartistsongs;
                    args[1] = numsongs;
                    args[2] = cursor
                              .getString(cursor
                                         .getColumnIndexOrThrow(MediaStore.Audio.Artists.ARTIST));
                    // builder.append(mResources.getQuantityString(R.plurals.Nsongscomp,
                    // numsongs, args));
                    // Only show how many songs
                    builder.append(mResources.getQuantityString(
                                       R.plurals.Nsongs, numartistsongs, args));
                    // end
                }
            }
