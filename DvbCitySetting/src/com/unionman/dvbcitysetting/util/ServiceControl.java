...
public class ServiceControl {
    ...
    private final String SERVICE_EMPTY = "non_service";
    ...
    public void stopService(OnServiceStopListener onServiceStopListener) {
        ...
        DvbServerManager.getInstance().killService();
    ...
    private void waitServiceStopped() {
        ...
        if (SERVICE_STOPPED.equals(status) || SERVICE_EMPTY.equals(status)) {
    ...
    private void waitServiceStart() {
        String status = getServiceStatus();
        if (SERVICE_RUNNING.equals(status) || SERVICE_EMPTY.equals(status)) {
    ...
    private String getServiceStatus() {
        ...
        return PropertyUtils.getString(key, SERVICE_EMPTY);
    }
