...
public class Dvn_email_read extends AppBaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dvt_email_read);
		...
		Log.i("read email","mailid:"+index_int);
		 ...
		 {
			new AlertDialog.Builder(Dvn_email_read.this).setMessage(R.string.pin_mail_not_read).setPositiveButton("ok", null).show();
		 }
    }
