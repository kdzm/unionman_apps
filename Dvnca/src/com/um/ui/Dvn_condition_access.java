...
public class Dvn_condition_access extends AppBaseActivity{
	final static String TAG = "Dvn_condition_access";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        button1.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				Intent it1 = new Intent(Dvn_condition_access.this,Dvn_smc_info.class);
				startActivity(it1);
			}
		});
/*
