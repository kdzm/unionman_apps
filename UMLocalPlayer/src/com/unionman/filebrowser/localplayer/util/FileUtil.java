...
public class FileUtil {
	...
	public static String getFileType(File seletedFile) {
		if(seletedFile.isFile()){
			...
			return CustomApplication.getContext().getResources().getString(R.string.directory);
		}else{
			return CustomApplication.getContext().getResources().getString(R.string.unknow);
		}
