 ...
 *
 */
public class ScreenSaverLogic implements InterfaceLogic {
    ...
    public ScreenSaverLogic(Context mContext) {
        super();
    ...
    public List<WidgetType> getWidgetTypeList() {
        ...
        // set name for SR
        mAutoPowerdown.setName(res.getStringArray(R.array.system_setting)[4]);
        // set type for SR
        ...
        mAutoPowerdown.setData(Util
                .createArrayOfParameters(InterfaceValueMaps.screen_saver));
