 ...
 *
 */
public class DemoModeLogic implements InterfaceLogic {

	private static int mDemo = 0;
    ...
    public DemoModeLogic(Context mContext) {
        super();
    ...
    public List<WidgetType> getWidgetTypeList() {
        ...
        // set name for SR
        mAutoPowerdown.setName(res.getStringArray(R.array.system_setting)[7]);
        // set type for SR
