 ...
 *
 */
public class StorageLogic implements InterfaceLogic {

	private static int mStorage = 0;
    ...
    public StorageLogic(Context mContext) {
        super();
    ...
    public List<WidgetType> getWidgetTypeList() {
        ...
        // set name for SR
        mAutoPowerdown.setName(res.getStringArray(R.array.system_setting)[9]);
        // set type for SR
