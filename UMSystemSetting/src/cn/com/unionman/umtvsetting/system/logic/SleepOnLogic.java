 ...
 *
 */
public class SleepOnLogic implements InterfaceLogic {
    ...
    public SleepOnLogic(Context mContext) {
        super();
    ...
    public List<WidgetType> getWidgetTypeList() {
        ...
        // set name for SR
        mAutoPowerdown.setName(res.getStringArray(R.array.system_setting)[3]);
        // set type for SR
        ...
        mAutoPowerdown.setData(Util
                .createArrayOfParameters(InterfaceValueMaps.sleep_on));
