...
public class Constant {
	...
	public static final int DATAPICK_DISMISS =1;
	public static final int TIMEPICK_DISMISS =2;
	public static final int DELAY_TIME_30S =30000;
    ...
    public static final String ACTION_SECURITY_SETTINGS = "unionman.settings.SECURITY_SETTINGS";
}
